# 特殊命令`sed`、`awk`、`grep`、`sort`

> 原文:[https://www . learn shell . org/en/Special _ Commands _ _ sed % 2 cawk % 2c grep % 2c sort](https://www.learnshell.org/en/Special_Commands__sed%2Cawk%2Cgrep%2Csort)
